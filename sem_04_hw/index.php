    ...
    $work_exp = [
        ...
        [
            ...
            'description' => 'Consectetur adipisicing elit. Praesentium magnam
                                ...
                                reprehenderit sunt hic. Nulla tempora soluta ea
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
              <h5 class="w3-opacity"><b><?= $work_exp[$i]['position']; ?></b></h5>
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $work_exp[$i]['period_start']; ?> -
                  <?php if ($work_exp[$i]['period_end'] == null) {
                  echo '<span class="w3-tag w3-teal w3-round">Current</span>';
                  } else {
                      echo $work_exp[$i]['period_end'];
                  } ?>
              </h6>
